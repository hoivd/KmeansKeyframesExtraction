...
def main():
    ...
    features_path = "../data/embeddings/beits3_L21_V001_features.pkl"

    # Nơi lưu keyframes
    save_path = "../output_beits3_L21_V001_torch"
    ...
    keyframes_index_file = '../output_torch/L21_V005_keyframes_index.json'
